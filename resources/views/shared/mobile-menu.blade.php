    ...
    <div class="container">
        ...
        <div class="mmenu-inner pt-10">
            ...
            <nav class="flex flex-col mt-8">
                <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Home</a>
                <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Product catalog</a>
