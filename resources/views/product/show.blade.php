    ...
    <main class="py-16 lg:py-20">
        <div class="container">
                    ...
                    <div class="grow flex flex-col lg:py-8">
                        ...
                        <form class="space-y-8 mt-8">
                                        ...
                                        <select id="filter-item-1"
                                            ...
                                            @foreach($values as $value)
                                                <option value="{{ $value->id }}"
                                                        class="text-dark">{{ $value->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                @endforeach
                            ...
                            <div class="flex flex-wrap items-center gap-3 xs:gap-4">
                                ...
                                <a href="#" class="w-[68px] !px-0 btn btn-purple" title="To favorites">
            ...
            <section class="mt-16 xl:mt-24">
                <h2 class="mb-12 text-lg lg:text-[42px] font-black">Viewed products</h2>
                <div
                    ...
                    @foreach($viewedProducts as $viewedProduct)
                        @include('product.shared.product', ['product' => $viewedProduct])
                    @endforeach
                </div>
            </section>
        </div>
